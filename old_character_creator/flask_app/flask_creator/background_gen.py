...
def backstory_creator():
    ...
    choice = randint(0,3)
    if choice == 0:
        return ("You're " + str(vowel_check(adjective)) + ' ' + str(adjective) + " character who comes from " + str(location) + " who " + str(backstory))
    elif choice == 1:
        return ("Listen here, you " + str(adjective) + " son of a bitch, I don't care if you're from " + str(location) + ',' + " saying you're someone who " + str(backstory) + " still won't get you in here")
    elif choice == 2:
        return ("Have you heard about that " + str(adjective) + " fellow? I heard that they're from " + str(location)+". " + "Even worse, they" + str(backstory)+"." + " Isn't that interesting?")
    elif choice == 3:
        return("This is your cover story. You're from " + str(location) + " and if someone asks you for your history, just say that you " + str(backstory)+". " + "Always try to get across that you're" + str(adjective)+".")
