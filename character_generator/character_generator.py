...
class CharacterCreator:
    ...
    def char_generator(self):
        ...
        # select of character "attributes" depending on input
        self.character.m_race = self.get_user_or_random_choice("m_race", race_list)
        self.character.s_race = self.get_user_or_random_choice("s_race", race_list[self.character.m_race]["subraces"])
        racial_bonus = race_list[self.character.m_race]["subraces"][self.character.s_race]

        self.character.m_class = self.get_user_or_random_choice("m_class", class_list)
        self.character.s_class = self.get_user_or_random_choice("s_class", class_list[self.character.m_class]["subclasses"])
        build = class_list[self.character.m_class]["subclasses"][self.character.s_class]

        self.character.background = self.get_user_or_random_choice("background", background_list)
        ...
        #set proficiencies
        skill_list = background_list[self.character.background]["skill_proficiencies"]
        skill_list += self.set_random_class_skills(class_list[self.character.m_class]["skill_proficiencies"], skill_list)
