...
class Character:
    def __init__(self, expansion, homebrew, usermade, optimise):
        self.name = None
        self.m_race = None
        self.s_race = None
        self.m_class = None
...
while answer not in possible_negatives:
    print("Please just stick to entering what you're meant to, coding for bad inputs is no fun")
    print("Enter 0 or 1 for the following questions")

    expansion = int(input("Would you like to include expansion material? 0 = no, 1 = yes "))
    homebrew = int(input("Would you like to include Matt Mercer homebrew material? 0 = no, 1 = yes "))
    usermade = int(input("Would you like to make the character yourself? 0 = computer, 1 = usermade "))
    optimise = int(input("How do you want ability rolls distributed? 0 = randomly, 1 = optimised "))

    print()

    char = MultiCharacter(flag(expansion), flag(homebrew), flag(usermade), flag(optimise))
    char.char_generator()

    multiclass = int(input("Would you like to multiclass? 0 = no, 1 = yes "))
    if flag(multiclass):
        char.multi_class()
